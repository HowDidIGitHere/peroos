...
class Comment extends React.Component {
  ...
  render() {
    const commenterColor = {
      color: this.props.comment.commenter_color ? this.props.comment.commenter_color : '#1a6dcd'
    };
        ...
        <div className='comment-list-item-container'>
          <div className='comment-user-icon-container'>
            <Link to='#' className='comment-user-icon'>
              <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="user-circle" style={commenterColor} className="svg-inline--fa fa-user-circle fa-w-16" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
