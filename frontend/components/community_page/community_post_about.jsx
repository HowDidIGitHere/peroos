...
const CommunityPostAbout = (props) => {
  const communityColor = {
    color: props.community.color ? props.community.color : '#1a6dcd'
  };
      ...
      <div className='about-community-sub-name'>
        {
          props.community.sub ? (
            <Link to={`/${props.community.sub}`}>
              ...
              {/* <span className='border-circle'> */}
                <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="product-hunt" style={communityColor} className="sub-icon svg-inline--fa fa-product-hunt fa-w-16" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
