            ...
            <div className='community-text-panel'>
              <div className='community-header-text'>
                ...
                <span className='community-header-sub-icon'>
                  <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="product-hunt" className="community-sub-icon svg-inline--fa fa-product-hunt fa-w-16" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
